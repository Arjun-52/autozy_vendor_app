class ApiEndpoints {
  ...
  static const String sendOtp = '/api/v1/auth/staff/send-otp';
  static const String verifyOtp = '/api/v1/auth/staff/verify-otp';
  static const String refreshToken = '/api/v1/auth/refresh';
  static const String adminServiceRecords = '/api/v1/admin/services/records';
  static const String adminInspections = '/api/v1/admin/inspections';
